...
Kid.create(name: "Jean", age: 10, localisation:"Marseille", service: "Jardinage", price:15, user_id: user2.id)
...
Kid.create(name: "Ben", age: 8, localisation:"Bordeaux", service: "Nettoyage de vitres", price:10, user_id: user4.id)
Kid.create(name: "Lisa", age: 7, localisation:"Marseille", service: "Etendre le linge", price:16, user_id: user3.id)
...
Kid.create(name: "Marius", age: 8, localisation:"Marseille", service: "Nettoyage des vitres", price:11, user_id: user2.id)
